...
from networks.loss import cas_mvsnet_loss, STsatmvsloss, cas_emvsnet_loss, hyper_loss
...
parser.add_argument('--model', default="eucs", help='select model', choices=['samsat', 'red', "casmvs", "ucs", "emvs", "eucs"])
...
parser.add_argument('--summary_freq', type=int, default=30, help='print and summary frequency')
...
TrainImgLoader = DataLoader(train_dataset, args.batch_size, shuffle=True, num_workers=0, drop_last=True, pin_memory=False)
TestImgLoader = DataLoader(test_dataset, args.batch_size, shuffle=False, num_workers=0, drop_last=False, pin_memory=False)
